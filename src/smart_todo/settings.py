...
SECRET_KEY = 'django-insecure-p+r=#wk6djt83&okgti$+0-@aymk+rmf^8p^n5b(9#4%xwa@ly'
...
INSTALLED_APPS = [
    ...
    "tasks",
    "rest_framework",
    "corsheaders",  # Allow frontend to access Django API
]
...
# Email Configuration to send reminders about tasks that are due tomorrow
